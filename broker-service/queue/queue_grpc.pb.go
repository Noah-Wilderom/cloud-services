...
type QueueListenerServiceClient interface {
	InsertJob(ctx context.Context, in *Job, opts ...grpc.CallOption) (*Job, error)
...
func (c *queueListenerServiceClient) InsertJob(ctx context.Context, in *Job, opts ...grpc.CallOption) (*Job, error) {
	out := new(Job)
	err := c.cc.Invoke(ctx, "/queue.QueueListenerService/InsertJob", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueueListenerServiceServer interface {
	InsertJob(context.Context, *Job) (*Job, error)
...
func (UnimplementedQueueListenerServiceServer) InsertJob(context.Context, *Job) (*Job, error) {
...
func _QueueListenerService_InsertJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Job)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueueListenerServiceServer).InsertJob(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/queue.QueueListenerService/InsertJob",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueueListenerServiceServer).InsertJob(ctx, req.(*Job))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _QueueListenerService_InsertJob_Handler,
		},
		{
