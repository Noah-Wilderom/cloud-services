...
mysql $DB_DATABASE -e "CREATE USER '$DB_USER'@'localhost' IDENTIFIED BY '$DB_PASSWORD';CREATE DATABASE IF NOT EXISTS $DB_DATABASE;GRANT ALL PRIVILEGES ON $DB_DATABASE.* TO '$DB_USER'@'localhost' WITH GRANT OPTION;FLUSH PRIVILEGES;"
